...
class GroqService:
    ...
    def validate_connection(self) -> bool:
        """
        Validate that the Groq API key is functional.
    ...
    def generate_content(
        ...
        """
        logger.info("Sending prompt to Groq | length=%d chars", len(prompt))
        try:
            ...
            logger.info("Content generated | tokens=%s", getattr(response.usage, "total_tokens", "?"))
            return content
